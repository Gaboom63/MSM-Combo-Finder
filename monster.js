...
const epicBreedingCombinations = {
  ...
  "Reebro": [`T-Rox + Pango <br> Soz + Kazilleon`],
...
const breedingCombinations = {
  ...
  "Shugabush + Mammott": ["Shugarock", "Mammott", "Rare Mammott", "Epic PomPom"],
  "Shugabush + Potbelly": ["Shugabass", "Potbelly", "Rare Potbelly", "Epic Deedge"],
  "Shugabush + Oaktopus": ["Shugajo", "Oaktopus", "Rare Oaktopus", "Epic Mammott", "Viveine", "Rare Viveine"],
  "Shugabush + Furcorn": ["Shugabeats", "Furcorn", "Rare Furcorn", "Epic Potbelly"],
  "Shugabush + Quibble": ["Shugabuzz", "Quibble", "Rare Quibble", "Epic Oaktopus"],
  "Shugabush + PomPom": ["Shugitar", "PomPom", "Rare PomPom", "Epic Viveine"],
  "Shugabush + Deedge": ["Shugavox", "Deedge", "Rare Deedge", "Epic Furcorn"],
  ...
  "Congle + Woolabee": ["Cherubble", "Rare Cherubble"],
  "Cataliszt + G'joob": ["Bleatnik"],
  "Cataliszt + Strombonin": ["Cranchee"],
  ...
  "Riff + Tweedle": ["Schmoochle", "Rare Schmoochle"],
  "Spunge + Scups": ["Blabbit", "Rare Blabbit"],
  "PomPom + Pango": ["Hoola", "Rare Hoola"],
  "Punkleton + Blabbit": ["Viveine", "Rare Viveine"],
  "Yool + Hoola": ["Monculus", "Rare Monculus"],
  "Punkleton + Yool": ["Gobbleygourd", "Rare Gobbleygourd"],
  "Blabbit + Hoola": ["Spurrit", "Rare Spurrit"],
  "Yool + Blabbit": ["Whiz-bang", "Rare Whiz-bang"],
  "Schmoochle + Hoola": ["Boo'qwurm", "Rare Boo'qwurm"],
  "Schmoochle + Blabbit": ["Ffidyll", "Rare Ffidyll"],
  "Punkleton + Schmoochle": ["Clavavera", "Rare Clavavera"],
  "Yool + Schmoochle": ["Carillong", "Rare Carillong"],
  "Punkleton + Hoola": ["Jam Boree", "Rare Jam Boree"],
